...
define PIPEWIRE_DWD_DEPENDENCIES
	...
	$(HOST_DIR)/bin/curl --insecure -L https://www.lua.org/ftp/lua-5.4.4.tar.gz               -o $(@D)/subprojects/packagecache/lua-5.4.4.tar.gz
	$(HOST_DIR)/bin/curl --insecure -L https://wrapdb.mesonbuild.com/v2/lua_5.4.4-1/get_patch -o $(@D)/subprojects/packagecache/lua_5.4.4-1_patch.zip
endef
